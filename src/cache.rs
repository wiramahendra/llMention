...
impl Cache {
    ...
    /// Key includes domain + model + prompt + UTC date so results expire daily
    /// and different domains never share entries.
    fn key(domain: &str, model: &str, prompt: &str) -> String {
